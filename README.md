...
This function combines eye movement and EEG/ECG data using the "EYE-EEG" plugin in EEGLAB, downsamples the EEG data to 250 Hz, and merges EEG data from the linguistic and nonlinguistic recordings. <br />
